...
failures as typed exceptions in :mod:`hardware_hunter.domain.errors`.
...
from hardware_hunter.adapters.wallapop_api.schema import (
    WallapopApiItem,
...
class WallapopApiFetcher(PageFetcher):
    ...
    async def fetch(self, listing_url: str) -> Listing:
        ...
        Used by ``hardware-hunter explain <url>`` (Epic 4) and the
