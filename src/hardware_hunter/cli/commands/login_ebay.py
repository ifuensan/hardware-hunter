"""``hardware-hunter login ebay`` — Story 2.10 (FR42, NFR-I5, NFR-S2, AR21).
...
def run(
    ...
    *,
    ...
    render_prose(f"Open this URL to authorize hardware-hunter:\n{consent_url}", style="info")
    ...
    if not code:
        render_prose(
            ...
            style="error",
            hint="re-run hardware-hunter login ebay and paste the code from the redirect URL",
        )
        return 4
    ...
    try:
        ...
        render_prose(
            ...
            style="error",
            hint="re-run hardware-hunter login ebay and re-paste the code",
        )
        return 4
