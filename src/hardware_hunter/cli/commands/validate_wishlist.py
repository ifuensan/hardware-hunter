"""``hardware-hunter validate-wishlist`` — FR40 + Story 2.4.
...
SCOPE_ERROR_HINT_1 = (
    "hardware-hunter does not support arbitrage scoring per the (c3) scope contract."
)
SCOPE_ERROR_HINT_2 = (
    "See ROADMAP.md for the future-research repo path: "
    "github.com/ifuensan/hardware-hunter-research (stub)."
)
